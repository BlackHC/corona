"""
Aborted in favor of a refactoring
"""
import numpy as np
...
# Will go to hospital
INFECTION_STATE_SEVERE_SYMPTOMATIC = 3
INFECTION_STATE_INVALID = -1

# Location state
LOCATION_STATE_NORMAL = 0
LOCATION_STATE_HOSPITAL = 1
...
@dataclass
class World:
    population: np.recarray
    free_hospital_beds: int
    free_icu_beds: int


def create_world(population_size):
    population = create_population(population_size)
    return World(population, TOTAL_HOSPITAL_BEDS, TOTAL_ICU_BEDS)
